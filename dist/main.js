...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Player; });\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ \"./assets/javascript/constants.js\");\n/* harmony import */ var _util_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util/util */ \"./assets/javascript/util/util.js\");\n/* harmony import */ var _util_vector2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util/vector2 */ \"./assets/javascript/util/vector2.js\");\n/* harmony import */ var _moving_object__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./moving_object */ \"./assets/javascript/moving_object.js\");\n/* harmony import */ var _movement_state_player_state__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./movement/state/player_state */ \"./assets/javascript/movement/state/player_state.js\");\n/* harmony import */ var _movement_player_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./movement/player_controller */ \"./assets/javascript/movement/player_controller.js\");\n/* harmony import */ var _movement_input_manager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./movement/input_manager */ \"./assets/javascript/movement/input_manager.js\");\n/* harmony import */ var _util_animation_manager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./util/animation_manager */ \"./assets/javascript/util/animation_manager.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass Player extends _moving_object__WEBPACK_IMPORTED_MODULE_3__[\"default\"] {\r\n    constructor(options) {\r\n        super(options);\r\n        this.pos = new _util_vector2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](_constants__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, 100);\r\n        this.vel = new _util_vector2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](0, 0);\r\n\r\n        this.initMovementAndState();\r\n        this.initDrawAndAnimation();\r\n    }\r\n\r\n    draw(ctx) {\r\n        const drawX = this.pos.x - _constants__WEBPACK_IMPORTED_MODULE_0__[\"PLAYER_DRAW_WIDTH\"] / 2;\r\n        const drawY = _constants__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] - this.pos.y - _constants__WEBPACK_IMPORTED_MODULE_0__[\"PLAYER_DRAW_HEIGHT\"];\r\n\r\n        // img, sourceX, sourceY, sourceH, sourceW, canvasX, canvasY, width, height\r\n        if (this.facing === 1) {\r\n            ctx.drawImage(this.imageRight, ...this.animationManager.sprite, 100, 74,\r\n                drawX, drawY, 80, 59);\r\n        } else {\r\n            ctx.drawImage(this.imageLeft, ...this.animationManager.sprite, 100, 74,\r\n                drawX, drawY, 80, 59);\r\n        }\r\n\r\n\r\n        // draw player hitbox\r\n        ctx.strokeStyle = 'red';\r\n        ctx.strokeRect(this.pos.x - this.size.x / 2,\r\n            _constants__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] - this.pos.y - this.size.y, this.size.x, this.size.y);\r\n    }\r\n\r\n    move() {\r\n        const inputFlags = this.inputManager.inputFlags;\r\n        this.currentState = this.currentState.handleInput(this.controller, inputFlags);\r\n\r\n        // process state with current inputs\r\n        this.currentState.handleUpdate(this.controller, inputFlags);\r\n\r\n        // move player with controller\r\n        this.controller.move();\r\n\r\n        // update animation\r\n        this.updateAnimation(inputFlags.dirX);\r\n    }\r\n\r\n    updateAnimation(dirX) {\r\n        this.facing = (dirX != 0) ? dirX : this.facing;\r\n\r\n        switch (this.currentState.name) {\r\n            case \"WALKING\":\r\n                this.animationManager.walk(this.facing);\r\n                break;\r\n            case \"RISING\":\r\n                this.animationManager.jump(this.facing);\r\n                break;\r\n            case \"FALLING\":\r\n                this.animationManager.fall(this.facing);\r\n                break;\r\n            case \"ROLLING\":\r\n                this.animationManager.roll(this.facing);\r\n                break;\r\n            case \"WALLSLIDING\":\r\n                this.facing = this.controller.wallDirection();\r\n                this.animationManager.wallslide(this.facing);\r\n                break;\r\n            default:\r\n                this.animationManager.idle(this.facing);\r\n        }\r\n    }\r\n\r\n    remove() {\r\n        this.game.end();\r\n    }\r\n\r\n    initMovementAndState() {\r\n        this.inputManager = new _movement_input_manager__WEBPACK_IMPORTED_MODULE_6__[\"default\"](this);\r\n        this.controller = new _movement_player_controller__WEBPACK_IMPORTED_MODULE_5__[\"default\"](this);\r\n        this.currentState = _movement_state_player_state__WEBPACK_IMPORTED_MODULE_4__[\"default\"].IDLE;\r\n        this.facing = 1;\r\n    }\r\n\r\n    initDrawAndAnimation() {\r\n        this.imageRight = new Image();\r\n        this.imageRight.src = '../assets/images/character_sheet_right.png';\r\n        this.imageLeft = new Image();\r\n        this.imageLeft.src = '../assets/images/character_sheet_left.png';\r\n        this.animationManager = new _util_animation_manager__WEBPACK_IMPORTED_MODULE_7__[\"default\"]();\r\n        _movement_state_player_state__WEBPACK_IMPORTED_MODULE_4__[\"default\"].animator = this.animationManager;\r\n    }\r\n}\n\n//# sourceURL=webpack:///./assets/javascript/player.js?");
